...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TBActionSheet/TBActionSheet.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TokenNetworking/TokenNetworking.framework"
